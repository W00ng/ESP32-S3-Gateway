...
esp_err_t touch_panel_calibration(void)
{
    ...
    lcd_draw_touch_point(lcd_panel, LCD_WIDTH - 20, 20, COLOR_BLACK);
    ...
    while (1)
    {
        if (ESP_OK == ns2009_get_press(&press))
        {
            ...
            {
            case 1:
                lcd_draw_touch_point(lcd_panel, LCD_WIDTH - 20, 20, COLOR_WHITE);              
                lcd_draw_touch_point(lcd_panel, LCD_WIDTH - 20, LCD_HEIGHT - 20, COLOR_BLACK); 
                break;
            case 2:
                lcd_draw_touch_point(lcd_panel, LCD_WIDTH - 20, LCD_HEIGHT - 20, COLOR_WHITE); 
                lcd_draw_touch_point(lcd_panel, 20, 20, COLOR_BLACK);                         
                break;
            case 3:
                lcd_draw_touch_point(lcd_panel, 20, 20, COLOR_WHITE);         
                lcd_draw_touch_point(lcd_panel, 20, LCD_HEIGHT - 20, COLOR_BLACK);
                break;
            case 4:
                lcd_draw_touch_point(lcd_panel, 20, LCD_HEIGHT - 20, COLOR_WHITE);
