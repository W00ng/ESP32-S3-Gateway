...
// #define LED_RED_SYSTEM_GPIO                 GPIO_NUM_NC
#define LED_BLUE_WIFI_GPIO                  GPIO_NUM_NC
#define LED_GREEN_4GMODEM_GPIO              GPIO_NUM_NC
#define MODEM_POWER_GPIO                    GPIO_NUM_NC
